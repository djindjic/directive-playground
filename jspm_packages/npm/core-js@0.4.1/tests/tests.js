...
(function(process) {
  ...
  (function() {
    ...
    test('.every', function() {
      ...
      every(obj = {q: 1}, function(val, key, that) {
        ok(val === 1);
        ok(key === 'q');
        ok(that === obj);
        return ok(this === ctx);
    ...
    test('.filter', function() {
      ...
      filter(obj = {q: 1}, function(val, key, that) {
        ok(val === 1);
        ok(key === 'q');
        ok(that === obj);
        return ok(this === ctx);
    ...
    test('.find', function() {
      ...
      find(obj = {q: 1}, function(val, key, that) {
        ok(val === 1);
        ok(key === 'q');
        ok(that === obj);
        return ok(this === ctx);
    ...
    test('.findKey', function() {
      ...
      findKey(obj = {q: 1}, function(val, key, that) {
        ok(val === 1);
        ok(key === 'q');
        ok(that === obj);
        return ok(this === ctx);
    ...
    test('.forEach', function() {
      ...
      forEach(obj = {q: 1}, function(val, key, that) {
        ok(val === 1);
        ok(key === 'q');
        ok(that === obj);
        ok(this === ctx);
    ...
    test('.map', function() {
      ...
      map(obj = {q: 1}, function(val, key, that) {
        ok(val === 1);
        ok(key === 'q');
        ok(that === obj);
        return ok(this === ctx);
    ...
    test('.mapPairs', function() {
      ...
      mapPairs(obj = {q: 1}, function(val, key, that) {
        ok(val === 1);
        ok(key === 'q');
        ok(that === obj);
        return ok(this === ctx);
    ...
    test('.reduce', function() {
      ...
      reduce(obj = {a: 1}, function(memo, val, key, that) {
        ok(memo === foo);
        ok(val === 1);
        ok(key === 'a');
        return ok(that === obj);
    ...
    test('.some', function() {
      ...
      some(obj = {q: 1}, function(val, key, that) {
        ok(val === 1);
        ok(key === 'q');
        ok(that === obj);
        return ok(this === ctx);
    ...
    test('.turn', function() {
      ...
      turn(obj = {q: 1}, function(memo, val, key, that) {
        deepEqual(memo, Dict());
        ok(val === 1);
        ok(key === 'q');
        return ok(that === obj);
      });
      turn({q: 1}, function(it) {
        return ok(it === obj);
      }, obj = {});
      deepEqual(turn({
        q: 1,
  ...
  (function() {
    ...
    test('Object.getOwnPropertyDescriptor', function() {
      ...
      deepEqual(getOwnPropertyDescriptor({q: 42}, 'q'), {
        writable: true,
        enumerable: true,
        configurable: true,
        value: 42
    ...
    test('Object.defineProperty', function() {
      ...
      ok((rez = defineProperty(src = {}, 'q', {value: 42})) === src);
      ok(rez.q === 42);
    });
    ...
    test('Object.getPrototypeOf', function() {
      ...
      ok(getPrototypeOf(create(obj = {q: 1})) === obj);
  ...
  (function() {
    ...
    test('Object.assign', function() {
      ...
      if (descriptors) {
        foo = {baz: 1};
        assign(foo, defineProperty({}, 'bar', {get: function() {
            return this.baz + 1;
          }}));
    ...
    if (Object.setPrototypeOf) {
      test('Object.setPrototypeOf', function() {
        ...
        eq(setPrototypeOf({a: 2}, {b: function() {
    ...
    test('Object#toString', function() {
      ...
      BadClass = (function() {
        ...
        var prototype = BadClass.prototype,
            constructor = BadClass;
    ...
    test('String.fromCodePoint', function() {
      ...
      tmp = 0x60;
      eq(fromCodePoint({valueOf: function() {
          return ++tmp;
        }}), 'a');
      eq(tmp, 0x61);
    ...
    test('String.raw', function() {
      ...
      eq(raw({raw: ['Hi\\n', '!']}, 'Bob'), 'Hi\\nBob!', 'raw is array');
      eq(raw({raw: 'test'}, 0, 1, 2), 't0e1s2t', 'raw is string');
      eq(raw({raw: 'test'}, 0), 't0est', 'lacks substituting');
      throws(function() {
        return raw({});
      }, TypeError);
      throws(function() {
  ...
  (function() {
    ...
    test('Reflect.defineProperty', function() {
      ...
      O = {};
      eq(Reflect.defineProperty(O, 'foo', {value: 123}), true);
      eq(O.foo, 123);
      if (MODERN) {
        O = {};
        ...
        eq(Reflect.defineProperty(O, 'foo', {value: 42}), false);
      }
    });
    test('Reflect.deleteProperty', function() {
      ...
      ok(!in$('bar', O));
      if (MODERN) {
        eq(Reflect.deleteProperty(Object.defineProperty({}, 'foo', {value: 42}), 'foo'), false);
      }
    });
    ...
    test('Reflect.get', function() {
      ...
      if (MODERN) {
        target = Object.create(Object.defineProperty({z: 3}, 'w', {get: function() {
            return this;
          }}), {
          x: {value: 1},
          y: {get: function() {
    ...
    test('Reflect.set', function() {
      ...
      if (MODERN) {
        ...
        target = Object.create(Object.defineProperty({z: 3}, 'w', {set: function(v) {
            return out = this;
          }}), {
          x: {
            value: 1,
  ...
  (function() {
    ...
    timeLimitedPromise = function(time, fn) {
      return Promise.race([new Promise(fn), new Promise(function(res, rej) {
  ...
  (function() {
    ...
    test('.define', function() {
      ...
      foo = {q: 1};
      ok(foo === define(foo, {w: 2}));
      ok(foo.w === 2);
      if (isNative(getOwnPropertyDescriptor)) {
        foo = {q: 1};
        foo2 = defineProperty({}, 'w', {get: function() {
            return this.q + 1;
          }});
        define(foo, foo2);
        ok(foo.w === 2);
    ...
    test('setInterval / clearInterval', function(it) {
      ...
      timeLimitedPromise(1e4, function(res, rej) {
        ...
        var ref$,
            ...
            b,
            i;
        ref$ = arg$ != null ? arg$ : {}, a = ref$.a, b = ref$.b, i = ref$.i;
